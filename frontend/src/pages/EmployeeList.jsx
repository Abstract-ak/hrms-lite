    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex space-x-3">
          ...
          >
            ...
            {/* Using Plus rotated as a subtle export icon or just text */}
            Export CSV
          </Button>
          <Button
      ...
      {showForm && (
        <Card className="p-6 border-primary-200 bg-primary-50/30">
          ...
          >
            ...
            {error && (
              <p className="col-span-full text-red-500 text-sm font-medium">
                {error}
              </p>
            )}
      ...
      <Card>
        <div className="p-4 border-b border-gray-100 flex flex-col sm:flex-row items-center gap-4">
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-sm border-none bg-transparent focus:ring-0 text-gray-900"
              value={searchTerm}
        ...
        {loading ? (
          ...
          <Table
            headers={["ID", "Full Name", "Department", "Attendance", "Actions"]}
          >
